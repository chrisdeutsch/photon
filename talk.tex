...
\note[itemize]{
	...
	\item absorption length plot (PDG) ?
}
...
\note[itemize]{
	...
	\item Auger electrons, fluorescence (?)
...
\begin{frame}{Pair production -- relation to bremsstrahlung}
	...
	\end{itemize}
	\begin{center}
		\includegraphics{./figures/crossing_symmetry.pdf}
	\end{center}
\end{frame}
...
\begin{frame}{Pair production -- cross section}
	\begin{itemize}
		...
		\item mean free path
		\begin{align*}
			\lambda_\mathrm{pair} \approx \frac{9}{7} X_0
		\end{align*}
		
		\item LPM suppression?
	\end{itemize}
\end{frame}
