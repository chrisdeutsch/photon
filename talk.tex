...
\note[itemize]{
	\item TODO: remove labels from photoelectric effect, compton scattering and pair production sketches
	\item TODO: possibly delete the slide with the absorption length plot
}
