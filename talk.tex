...
\begin{columns}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item quasifree for $E_\gamma \gg E_\mathrm{b}$
		\end{itemize}
	...
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Thomson cross section
				\begin{align*}
				\sigma_\mathrm{T} = \frac{8 \pi}{3} r_\mathrm{e}^2
				\end{align*}
...
\note[itemize]{
	\item Thomson -- $\sigma_\mathrm{T} = \frac{8 \pi}{3} r^2$ -- strong deviation
	...
	\begin{itemize}
		\item Careful! -- low energy limit for photons propagating through matter - Rayleigh scattering (scattering at bound electrons)
	\end{itemize}
